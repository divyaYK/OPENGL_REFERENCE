...
def main():
    ...
    cube_shader = ShaderLoader.compile_shader("resources/shaders/tut17_cube.vs", "resources/shaders/tut17_cube.fs")
    cube_tex = TextureLoader.load_texture("resources/cubeFiles/cube_texture.jpg")
    cube_texture_offset = len(cube.vertex_index) * 12

    monkey = ObjLoader()
    monkey.load_model("resources/monkey/monkey.obj")
    monkey_shader = ShaderLoader.compile_shader("resources/shaders/tut17_monkey.vs",
                                                "resources/shaders/tut17_monkey.fs")
    ...
    monster_shader = ShaderLoader.compile_shader("resources/shaders/tut17_monster.vs",
                                                 "resources/shaders/tut17_monster.fs")
