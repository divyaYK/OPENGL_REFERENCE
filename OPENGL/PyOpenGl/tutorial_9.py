...
def main():
    ...
    obj = ObjectLoader()
    obj.load_model("resources/cubeFiles/cube.obj")

    texture_offset = len(obj.vertex_index) * 12
    normal_offset = (texture_offset + len(obj.texture_index) * 8)

    shader = Shader_tut7.compile_shader("resources/shaders/tut_9.vs", "resources/shaders/tut_9.fs")
    ...
    # load image
    image = Image.open("resources/cubeFiles/cube_texture.jpg")
    ...
    projection = pyrr.matrix44.create_perspective_projection_matrix(100.0, w_width / w_height, 0.1, 100.0)
