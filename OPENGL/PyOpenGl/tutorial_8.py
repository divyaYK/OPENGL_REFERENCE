...
def main():
    ...
    shader = Shader_tut7.compile_shader("resources/shaders/tut_8.vs", "resources/shaders/tut_8.fs")
    ...
    projection = pyrr.matrix44.create_perspective_projection_matrix(150.0, w_width / w_height, 0.1, 100.0)
