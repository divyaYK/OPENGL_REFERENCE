...
def main():
    ...
    texture = TextureLoader.load_texture("resources/images/planks_brown_10_diff_1k.jpg")
    ...
    while not glfw.window_should_close(window):
        ...
        glDrawElementsInstanced(GL_TRIANGLES, len(indices), GL_UNSIGNED_INT, None, 20)
